...
<head>
    ...
    <title>Belgium Open Bruxelles</title>
</head>
<body>
    <div align = "center">
        <h1>Belgium Open Bruxelles</h1>
        <?php
            $user = 'root';
            $password = 'root';
            $db = 'fisi';
            ...
            // Perform query 
            if ($result = $conn -> query("SELECT * FROM Gara WHERE Citta = 'Bruxelles'")) {
            echo "Returned rows are: " . $result -> num_rows;
            }

            $query = "SELECT * FROM Gara WHERE Citta = 'Bruxelles'";
