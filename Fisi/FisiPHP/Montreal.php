...
<head>
    ...
    <title>Canada Champ Montreal</title>
</head>
<body>
    <div align = "center">
        <h1>Canada Champ Montreal</h1>
        <?php
            $user = 'root';
            $password = 'root';
            $db = 'fisi';
            ...
            // Perform query 
            if ($result = $conn -> query("SELECT * FROM Gara WHERE Citta = 'Montreal'")) {
            echo "Returned rows are: " . $result -> num_rows;
            }

            $query = "SELECT * FROM Gara WHERE Citta = 'Montreal'";
