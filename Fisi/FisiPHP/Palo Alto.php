...
<head>
    ...
    <title>Big Air 2 Palo Alto</title>
</head>
<body>
    <div align = "center">
        <h1>Big Air 2 Palo Alto</h1>
        <?php
            $user = 'root';
            $password = 'root';
            $db = 'fisi';
            ...
            // Perform query 
            if ($result = $conn -> query("SELECT * FROM Gara WHERE Citta = 'Palo Alto'")) {
            echo "Returned rows are: " . $result -> num_rows;
            }

            $query = "SELECT * FROM Gara WHERE Citta = 'Palo Alto'";
